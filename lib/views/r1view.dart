...
class R1view extends StatefulWidget {
  ...
  @override
  State<R1view> createState() => _R2viewState();
}

class _R2viewState extends State<R1view> {
  ...
  void initState() {
    ...
    print("🟢 R1view se ha inicializado y está esperando datos...");
    ...
    return Expanded(
      child: Column(
        ...
        children: [
          ...
          buildCustomButton(
              l4 ?? "",
              bt2 ? "assets/Aceptar.ico" : "assets/Mapa.ICO",
              select2,
              btDisable),
          buildCustomButton(
              l5 ?? "",
              bt3 ? "assets/Aceptar.ico" : "assets/Buscar.ico",
              select3,
              btDisable),
          buildCustomButton(
              l2 ?? "",
