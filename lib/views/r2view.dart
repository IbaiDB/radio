...
class R2view extends StatefulWidget {
  ...
  @override
  State<R2view> createState() => _R2viewState();
}

class _R2viewState extends State<R2view> {
  ...
  void initState() {
    ...
    print("🟢 R2view se ha inicializado y está esperando datos...");
    ...
    return Expanded(
      child: Column(
        ...
        children: [
          buildCustomButton(
              l3 ?? "",
              bt1 ? "assets/Aceptar.ico" : "assets/Transporte.ico",
              select1,
              btDisable),
          buildCustomButton(
              l4 ?? "",
              bt2 ? "assets/Aceptar.ico" : "assets/AsignacionPickings.ico",
              select2,
              btDisable),
          buildCustomButton(
              l5 ?? "",
              bt3 ? "assets/Aceptar.ico" : "assets/EAN.ico",
              select3,
              btDisable),
          buildCustomButton(
              l2 ?? "",
