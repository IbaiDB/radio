...
class Rcview extends StatefulWidget {
  ...
  @override
  State<Rcview> createState() => RcviewState();
}

class RcviewState extends State<Rcview> {
  String? l0, l1, l2, l3, l4, l5, l6, l7, l8, l9, lA, t0, t1, tA, t3;
  ...
  void initState() {
    super.initState();
    print("🟢 Review se ha inicializado y está esperando datos...");
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (socketProvider.lastMessage != null) {
        ...
        if (socketProvider.lastMessage.contains("|RC|") &&
  ...
  void _socketListener() {
    try {
      ...
      if (socketProvider.lastMessage.contains("|RC|") &&
        ...
        if (socketProvider.lastMessage.contains("|RC|DI|t4||") &&
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|RC|DI|t4|Todos|") &&
            !_focusNodet4.hasFocus) {
          focusear(_focusNodet4);
          enviart4 = true;
          enviart8 = false;
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|RC|DI|t6|") &&
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|RC|DI|t7|") &&
          ...
          enviart7 = true;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|RC|DI|t8|") &&
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|RC|DI|t9|") &&
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|RC|DI|t2|") &&
