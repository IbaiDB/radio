...
class Prview extends StatefulWidget {
  ...
  @override
  State<Prview> createState() => PrviewState();
}

class PrviewState extends State<Prview> {
  String? l0, l1, l2, l3, l4, l5, l6, l7, l8, l9, lA, t0, t1, t3, t5, tA;
  ...
  void initState() {
    super.initState();
    print("🟢 Prview se ha inicializado y está esperando datos...");
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (socketProvider.lastMessage != null) {
        ...
        if (socketProvider.lastMessage.contains("|PR|") &&
  ...
  void focusear(FocusNode f) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!mounted || !f.context!.mounted) return;
  ...
  void dividirLabels(List<String> lines) {
    ...
    for (String line in lines) {
      ...
      if (mounted) {
        ...
        if (line.contains("CT") &&
            line.contains("t3") &&
            !line.contains("|t3||")) setState(() => t3 = lastPart);
        if (line.contains("t4") && !line.contains("|t4||"))
          setState(() => t4?.text = lastPart);
        if (line.contains("CT") &&
            line.contains("t5") &&
            !line.contains("|t5||")) setState(() => t5 = lastPart);
        ...
        if (line.contains("CT") && line.contains("|t3||"))
          setState(() => t3 = "");
        if (line.contains("|t4||")) setState(() => t4?.text = "");
        if (line.contains("CT") && line.contains("|t5||"))
          setState(() => t5 = "");
  ...
  void _socketListener() {
    try {
      ...
      if (socketProvider.lastMessage.contains("|PR|") &&
        ...
        if (socketProvider.lastMessage.contains("|PR|DI|t4||") &&
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|PR|DI|t4|Todos|") &&
            !_focusNodet4.hasFocus) {
          focusear(_focusNodet4);
          enviart4 = true;
          enviart8 = false;
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|PR|DI|t6|") &&
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|PR|DI|t7|") &&
          ...
          enviart7 = true;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|PR|DI|t8|") &&
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|PR|DI|t9|") &&
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|PR|DI|t2|") &&
  ...
  @override
  void dispose() {
    print("🛑 PrView se está desmontando");
    socketProvider.removeListener(_socketListener);
    super.dispose();
  }
