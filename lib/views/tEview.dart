...
class Teview extends StatefulWidget {
  ...
  @override
  State<Teview> createState() => TeviewState();
}

class TeviewState extends State<Teview> {
  ...
  void initState() {
    super.initState();
    print("🟢 Teview se ha inicializado y está esperando datos...");
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (socketProvider.lastMessage != null) {
        ...
        if (socketProvider.lastMessage.contains("|TE|") &&
  ...
  void _socketListener() {
    try {
      ...
      if (socketProvider.lastMessage.contains("|TE|") &&
        ...
        if (socketProvider.lastMessage.contains("|TE|DI|t4||")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|TE|DI|t4|Todos|")) {
          focusear(_focusNodet4);
          enviart4 = true;
          enviart8 = false;
          enviart9 = false;
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|TE|DI|t6|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|TE|DI|t7|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|TE|DI|t8|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|TE|DI|t9|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|TE|DI|t2|")) {
  ...
  @override
  void dispose() {
    print("🛑 TeView se está desmontando");
    socketProvider.removeListener(_socketListener);
    super.dispose();
  }
