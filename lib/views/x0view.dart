...
class X0view extends StatefulWidget {
  ...
  @override
  State<X0view> createState() => _X0viewState();
}

class _X0viewState extends State<X0view> {
  ...
  void initState() {
    ...
    print("🟢 X0view se ha inicializado y está esperando datos...");
  ...
  void _socketListener() {
    try {
      if (!mounted) {
        print("⚠️ X0View está desmontado, ignorando mensaje");
        return;
      }
      if (socketProvider.lastMessage.contains("|X0|")) {
        setState(() {
          btDisable = false;
          bt1 = false;
          bt2 = false;
  ...
  Widget montarMenu(
    ...
    VoidCallback select2,
    VoidCallback select3,
    VoidCallback select0,
  ) {
    return Expanded(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: [
          ...
          buildCustomButton(
              l4 ?? "",
              bt2 ? "assets/Aceptar.ico" : "assets/Palet.ico",
              select2,
              btDisable),
          buildCustomButton(
              l5 ?? "",
              bt3 ? "assets/Aceptar.ico" : "assets/Entradas.ico",
              select3,
              btDisable),
          buildCustomButton(
              l2 ?? "",
