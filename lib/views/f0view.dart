...
class F0view extends StatefulWidget {
  ...
  @override
  State<F0view> createState() => _F0viewState();
}

class _F0viewState extends State<F0view> {
  ...
  void initState() {
    ...
    print("🟢 F0view se ha inicializado y está esperando datos...");
  ...
  Widget montarMenu(VoidCallback select1, VoidCallback select0) {
    return Expanded(
      child: Column(
        ...
        children: [
          buildCustomButton(
              l3 ?? "",
              bt1 ? "assets/Aceptar.ico" : "assets/Fabricacion.ico",
              select1,
              btDisable),
          buildCustomButton(
              l2 ?? "",
