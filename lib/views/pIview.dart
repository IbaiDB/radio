...
class Piview extends StatefulWidget {
  ...
  @override
  State<Piview> createState() => PiviewState();
}

class PiviewState extends State<Piview> {
  String? l0, l1, l2, l3, l4, l5, l6, l7, l8, l9, lA, t0, t1, tA, t7;
  ...
  void initState() {
    super.initState();
    print("🟢 Piview se ha inicializado y está esperando datos...");
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (socketProvider.lastMessage != null) {
        ...
        if (socketProvider.lastMessage.contains("|PI|") &&
  ...
  void _socketListener() {
    try {
      if (!mounted) {
        print("⚠️ PiView está desmontado, ignorando mensaje");
        return;
      }

      if (socketProvider.lastMessage.contains("|PI|DI|") &&
              !socketProvider.lastMessage.contains(
                  "|CC|") /*&&
           !socketProvider.lastMessage.contains("|SO|")*/
          ) {
        if (socketProvider.lastMessage.contains("|PI|DI|t4||")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|PI|DI|t4|Todos|")) {
          focusear(_focusNodet4);
          enviart4 = true;
          enviart8 = false;
          enviart9 = false;
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|PI|DI|t6|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|PI|DI|t7|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|PI|DI|t8|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|PI|DI|t9|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|PI|DI|t2|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|PI|DI|t5|")) {
  ...
  void dividirLabels(List<String> lines) {
    ...
    for (String line in lines) {
      ...
      if (line.contains("CT") || line.contains("DI")) {
  ...
  Future lanzarteclado() async {
    final resultado = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => KeyboardScreenView()),
    );
    if (resultado != null) {
      setState(() {
        if (enviart4) {
