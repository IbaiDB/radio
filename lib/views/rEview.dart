...
class ReviewState extends State<Review> {
  String? l0, l1, l2, l3, l4, l5, l6, l7, l8, l9, lA, t0, t1, tA;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (socketProvider.lastMessage != null) {
        ...
        if (socketProvider.lastMessage.contains("|RE|") &&
  ...
  void _socketListener() {
    try {
      ...
      if (socketProvider.lastMessage.contains("|RE|") &&
        ...
        if (socketProvider.lastMessage.contains("|RE|DI|t4||") &&
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|RE|DI|t4|Todos|") &&
            !_focusNodet4.hasFocus) {
          focusear(_focusNodet4);
          enviart4 = true;
          enviart8 = false;
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|RE|DI|t6|") &&
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|RE|DI|t7|") &&
          ...
          enviart7 = true;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|RE|DI|t8|") &&
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|RE|DI|t9|") &&
          ...
          enviart7 = false;
          enviart2 = false;
        } else if (socketProvider.lastMessage.contains("|RE|DI|t2|") &&
