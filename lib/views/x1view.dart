...
class X1view extends StatefulWidget {
  ...
  @override
  State<X1view> createState() => _X1viewState();
}

class _X1viewState extends State<X1view> {
  ...
  void initState() {
    ...
    print("🟢 X1view se ha inicializado y está esperando datos...");
  ...
  void dividirLabels(List<String> lines) {
    print("🔍 Procesando líneas en X1view:");
    ...
    return Expanded(
      child: Column(
        ...
        children: [
          buildCustomButton(
              l3 ?? "",
              bt1 ? "assets/Aceptar.ico" : "assets/Palet2.ico",
              select1,
              btDisable),
          buildCustomButton(
              l4 ?? "",
              bt2 ? "assets/Aceptar.ico" : "assets/Caja.ico",
              select2,
              btDisable),
          buildCustomButton(
              l2 ?? "",
