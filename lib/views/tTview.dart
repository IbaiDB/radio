...
class Ttview extends StatefulWidget {
  ...
  @override
  State<Ttview> createState() => TtviewState();
}

class TtviewState extends State<Ttview> {
  ...
  void initState() {
    super.initState();
    print("🟢 Ttview se ha inicializado y está esperando datos...");
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (socketProvider.lastMessage != null) {
        ...
        if (socketProvider.lastMessage.contains("|TT|") &&
  ...
  void _socketListener() {
    try {
      ...
      if (socketProvider.lastMessage.contains("|TT|DI|") &&
              !socketProvider.lastMessage.contains(
                  "|CC|") /*&&
           !socketProvider.lastMessage.contains("|SO|")*/
          ) {
        if (socketProvider.lastMessage.contains("|TT|DI|t4||")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|TT|DI|t4|Todos|")) {
          focusear(_focusNodet4);
          enviart4 = true;
          enviart8 = false;
          enviart9 = false;
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|TT|DI|t6|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|TT|DI|t7|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|TT|DI|t8|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|TT|DI|t9|")) {
          ...
          enviart3 = false;
          enviart5 = false;
        } else if (socketProvider.lastMessage.contains("|TT|DI|t2|")) {
          ...
          l4 = "";
          t4?.clear();
        } else if (socketProvider.lastMessage.contains("|TT|DI|t5|")) {
