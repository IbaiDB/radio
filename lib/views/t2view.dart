...
class T2view extends StatefulWidget {
  ...
  @override
  State<T2view> createState() => _T2viewState();
}
...
class _T2viewState extends State<T2view> {
  ...
  void initState() {
    ...
    print("🟢 T2view se ha inicializado y está esperando datos...");

    WidgetsBinding.instance.addPostFrameCallback((_) {
      final socketProvider = context.read<SocketProvider>();
      if (socketProvider.lastMessage != null) {
        if (socketProvider.lastMessage.contains("|T2|")) {
    ...
    return Expanded(
      child: Column(
        ...
        children: [
          buildCustomButton(
              l3 ?? "",
              bt1 ? "assets/Aceptar.ico" : "assets/Matricula.ico",
              select1,
              btDisable),
          buildCustomButton(
              l4 ?? "",
              bt2 ? "assets/Aceptar.ico" : "assets/Pedido.ico",
              select2,
              btDisable),
          buildCustomButton(
              l2 ?? "",
